...
// Module
___CSS_LOADER_EXPORT___.push([module.id, "body {\n  background-color: orange;\n}\nbody p {\n  color: red;\n}", "",{"version":3,"sources":["webpack://./src/style.scss"],"names":[],"mappings":"AAAA;EACE,wBAAA;AACF;AAAE;EACE,UAAA;AAEJ","sourcesContent":["body {\n  background-color: orange;\n  p {\n    color: red;\n  }\n}\n"],"sourceRoot":""}]);
// Exports
...
var loc = "Islington";
var key = "e2f88a64edb26908f2c8a836e0f87c19";
var url = "https://api.openweathermap.org/data/2.5/weather?q=".concat(loc, "&lang=gb&appid=").concat(key); // // Get client location
// const getLoc
// Get location input
...
function _getWeatherData() {
  _getWeatherData = _asyncToGenerator( /*#__PURE__*/_regeneratorRuntime().mark(function _callee(loc) {
    var response, data;
